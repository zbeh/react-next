...
export type BlogPostCardProps = IBlogPostSummary & {};

export const BlogPostCard: React.FC<BlogPostCardProps> = ({ title, thumbNailUrl, studyTime, author, postDate, numberOfViews, numberOfComments, isNew, slug }) => {
  return (
    <div className="card">
      {isNew && (
        <Badge variant="ghost" size="small" className="absolute right-2 top-2 !opacity-100">
          جدید
        </Badge>
      )}
      <figure>
